		...
		if (pathInfo == null || pathInfo.equals("/") ) {
			...
			if(ordenarPor != null && ordenarPor.equalsIgnoreCase("nombre")) {
				...
				if(modo != null && modo.equalsIgnoreCase("desc")) {
					...
					request.setAttribute("listaFabricantesDTO", fabDAO.getOrdenadoPorCodigoDesc());

				} else if (modo != null && modo.equalsIgnoreCase("asc")) {

					request.setAttribute("listaFabricantesDTO", fabDAO.getOrdenadoPorCodigoAsc());
				...
				//ASÍ QUE SE PONE EN EL ELSE PARA CUANDO SEA NULL, MUESTRA AL MENOS LOS FABRICANTES TAL COMO VIENEN EN LA TABLA
